...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={`
      ...
      disabled:opacity-50 dark:border-gray-800 dark:bg-gray-950 dark:focus:ring-blue-400
      ${className}`}
    {...props}
  >
    {children}
